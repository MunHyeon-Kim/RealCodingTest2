...
public class MockServiceTest {
    ...
    public void shouldDothrewExceptionWhenChampionSetNameYasuo(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void shouldOneTimeRunForChampionArraySize2(){
        List<Champion> mockChampions = mock(List.class);
    ...
    @Test
    public void shouldAtLeastThreeoTimesForChampionGetName() {
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
    ...
    @Test
    public void shouldPassWhenNaverRunChampionSetName(){
        Champion champion = mock(Champion.class);
        champion.setName("조이");
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
